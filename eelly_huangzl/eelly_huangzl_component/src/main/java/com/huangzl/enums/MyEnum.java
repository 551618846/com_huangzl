...
public class MyEnum{
	...
	public static void main(String[] args) {
		...
		EnumSet<MyEnumz> sets = EnumSet.allOf(MyEnumz.class);//EnumSet
		for(MyEnumz t:sets){
			t.print();
		}
		
		EnumMap<MyEnumz, String> map = new EnumMap<MyEnumz, String>(MyEnumz.class);//EnumMap
		
		
		System.err.println(MyEnumz.valueOf("D"));
		
		
		MyEnumz[] list = MyEnumz.values();
		for(MyEnumz t : list){
			t.print();
		}
