...
/**
 * @类名：SendMinMessage
 * @描述: queartz任务,发送权重为RocketMQConstant.WEIGHT_MIN的消息
...
public class SendMinMessage extends BaseMessageJob{
    ...
    public void sendMessageByWeight(IRocketMQFailHandlerDubboManager rocketMQFailHandlerDubboManager) {
        ...
        rocketMQFailHandlerDubboManager.sendMsgsByWeight(RocketMQConstant.WEIGHT_MIN);
    }
}
