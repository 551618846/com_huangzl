...
* @文件名：SendXMinMessage.java
* @创建时间： 2015年1月13日 上午10:39:21
...
/**
 * @类名：SendXMinMessage
 * @描述: queartz任务,发送权重为RocketMQConstant.WEIGHT_XMIN的消息
 * @创建人：<a href=mailto: huangzhenliang@eelly.net>huangzhenliang</a>
 * @修改人：
 * @修改时间：2015年1月13日 上午10:39:21
 * @修改说明：<br/>
 * @版本信息：V1.0.0<br/>
 */
@DisallowConcurrentExecution//保证一次只有一个实例运行,否则数据库需要加锁
public class SendXMinMessage extends BaseMessageJob{
    ...
    public void sendMessageByWeight(IRocketMQFailHandlerDubboManager rocketMQFailHandlerDubboManager) {
        ...
        rocketMQFailHandlerDubboManager.sendMsgsByWeight(RocketMQConstant.WEIGHT_XMIN);
    }
}
